...
Upgrading Nuget package is always not an easy process. While the packages are downloaded for you, the migration side effects are often obscure. Some packages are not upgraded often and have some recurring issues. Bootstrap is one that doesn't work well with Asp.Net MVC that it's easy to forget. [![badpath](http://patrickdesjardins.com/blog/wp-content/uploads/2016/10/badpath-1024x62.png)](http://patrickdesjardins.com/blog/?attachment_id=4813)
