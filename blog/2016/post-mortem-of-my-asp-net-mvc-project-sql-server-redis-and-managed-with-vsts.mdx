...
![](images/33MonthsNumberLinesOfCode.png)
...
![](images/6RealProjectsForBourseVirtuelle.png)
...
![](images/LinesOfCodeTrend-1024x530.png)
...
```csharp
 ...
 .InsertNewUser(1, (applicationUser, index) => { applicationUser.CanReceiveEmailWhenContestInscriptionStart = true; applicationUser.ValidationDateTime = null; });
```
...
![](images/RegistrationWindow-1024x462.png)
