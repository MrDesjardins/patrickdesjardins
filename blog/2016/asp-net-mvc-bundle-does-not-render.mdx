...
This is an example that will render only CSS and not JavaScript. \[csharp\] @Styles.Render("~/bundles/mywebsite") @Scripts.Render("~/bundles/mywebsite") \[/csharp\]

The solution is to have unique name. \[csharp\] @Styles.Render("~/bundles/css/mywebsite") @Scripts.Render("~/bundles/javascript/mywebsite") \[/csharp\]
