...
To import into Azure, you need to right click the Databases folder of Azure SQL Server. Select **Import Data-tier Application**. ![](images/ImportDataTierApplication.png)
