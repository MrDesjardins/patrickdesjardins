...
```html  <html> <head> <link href="bootstrap.css" rel="stylesheet"> <style type="text/css"> body { padding:30px; } </style> </head> <body> <!-- HERE YOUR CODE --> </body> <script src="bootstrap.js"></script> </html> 
...
```html  <div class="panel panel-default"> <div class="panel-heading">General Information</div> <div class="panel-body"> <!-- HERE YOUR CODE --> </div> </div> 
...
```html  div class="panel panel-default"> <div class="panel-heading"> General Information </div> <div class="panel-body"> @Html.Custom().FormGroupWithSeveralSubProperties(model => model.Name) @Html.Custom().FormGroupFor(model => model.InitialCapital) @Html.Custom().FormGroupFor(model => model.OrderType) </div> </div> 
...
```html  @{ Html.Custom().SetHeader(Model); } 
...
```html  <header> <div class="container"> <img id="titre\_img" src="@Url.Content("~/Content/Images/Logo/BourseVirtuelle.png")" alt="Logo" /> @{ Html.RenderPartial("\_Menu"); } @{ var headerTitle = ViewBag.HeaderTitle; var headerSubTitle = ViewBag.HeaderSubTitle; if (!string.IsNullOrWhiteSpace(headerTitle)) { <div id="header-title"> <h1> @headerTitle @if (!string.IsNullOrWhiteSpace(headerSubTitle)) { <small>@headerSubTitle</small> } </h1> </div> <hr/> } } </div> </header> 
...
```csharp
 namespace Model.Entities.Users { public class ApplicatioRole : IdentityRole { public const string ADMINISTRATOR = "Administrator"; public const string MODERATOR = "Moderator"; public const string NORMAL\_USER = "NormalUser"; public const string ADMINISTRATOR\_MODERATOR = ADMINISTRATOR + "," + MODERATOR; } } 
...
```csharp
 internal sealed class Configuration : DbMigrationsConfiguration<MainDbContext> { private readonly IRunningContext runningContext; const string EMAIL\_ADMIN = "123@123.com"; const string EMAIL\_NORMAL\_USER = "qwe@qwe.com"; const string EMAIL\_MOD = "asd@asd.com"; const string EMAIL\_SYSTEM = "system@system.com"; const string EMAIL\_TEST = "test@test.com"; //... 
...
```csharp
 public class ApplicationRole : IdentityRole { public const string ADMINISTRATOR = "Administrator"; public const string MODERATOR = "Moderator"; public const string NORMAL\_USER = "NormalUser"; public const string ADMINISTRATOR\_MODERATOR = ADMINISTRATOR + "," + MODERATOR; } 
``` This is used later in every actions.


```csharp
 [HttpGet] [Authorize(Roles = ApplicationRole.ADMINISTRATOR\_MODERATOR)] public ActionResult Edit(int id) { //... } 
...
```html  @model object <!DOCTYPE html> <html> ... ... @Html.Partial("\_Header", Model as IUIPermission ?? new UIPermission()) 
...
```html  @section scripts { <script> Application.ControldsId.SortId = "@Html.IdFor(d=>d.sortdir)"; Application.ControldsId.ColumnId = "@Html.IdFor(d=>d.sort)"; </script> <script src="~/Scripts/Customs/Views/ContestList.js"></script> } 
...
```html  @using WebSite.Resources @model object /\*This is required to work with the model passed by the controller\*/ <!DOCTYPE html> <html> <body> @Html.Partial("\_Header", Model) <div class="container body-content"> @RenderBody() </div> </body> </html> 
