...
![](images/DomainDnsWebSite-1024x88.png)
...
![](images/NameCheapAzureDnsAzureAppService-1024x139.png)
...
![](images/CustomDNSNameserver.png)

The advanced DNS, should remain with the value Standard Nameserver. ![](images/PersonalDnsServer-1024x166.png)
...
![](images/CustomDomainsSetting-1024x898.png)
