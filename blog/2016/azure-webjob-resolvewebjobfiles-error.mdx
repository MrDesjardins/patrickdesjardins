...
\[xml\] <Import Project="..\\packages\\Microsoft.Web.WebJobs.Publish.1.0.10\\tools\\webjobs.targets" Condition="Exists('..\\packages\\Microsoft.Web.WebJobs.Publish.1.0.10\\tools\\webjobs.targets')" /> \[/xml\]
