...
\[csharp\] public class OverallMapping: Profile { protected override void Configure() { base.CreateMap<HealthOverall, HealthOverallViewModel>(); } } \[/csharp\]
...
public static class Mapper{ public static IMapper MapperConfiguration; } \[/csharp\]

The static class and static property that hold all mapping is what you need to use in your application to map anything. \[csharp\] var viewModel = MapperFacade.MapperConfiguration.Map<HealthOverall, HealthOverallViewModel>(model); \[/csharp\]
