...
![Picture of how I look during a meeting](./images/configuration-computer_videooutput.png)
...
![Diagram of all physical components](./images/configuration_computer-components.png)
...
![Picture of my desk that shows the three cameras I have, the two monitors, and the computers](./images/configuration-computer_picture.png)
...
![OBS Fullscreen Projector](./images/configuration-computer_obs.png)
...
![Light House with EQ plugin](./images/configuration-computer_lighthost.png)
