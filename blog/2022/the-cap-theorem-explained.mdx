...
![User talks to web server which reach a database](./images/CAP_Theorem.drawio.png)
...
![Communicationn broken between web server and the databaes](./images/CAP_Theorem-Broken.drawio.png)
...
![Communicationn broken between web server and the database](./images/CAP_Theorem-CA.drawio.png)
...
![Two users that receive information from two different nodes](./images/CAP_Theorem-TwoUsersDifferentNode.drawio.png)
...
![Two users that receive information from two different nodes](./images/CAP_Theorem-CustomerEmailWorkerSpreadsheet.drawio.png)
...
![Two users that receive information from two different nodes](./images/CAP_Theorem-TwoShifts.drawio.png)
...
![Two spreadsheets](./images/CAP_Theorem-TwoSpreadsheets.drawio.png)
...
![Image with the communication between worker](./images/CAP_Theorem-SyncTwoSpreadsheets.drawio.png)
...
![Image of the starting synchronization](./images/CAP_Theorem-SyncCall.drawio.png)
...
![Adding a step where each email are sent to all employee and must be confirmed that is processed](./images/CAP_Theorem-MoreEmails.drawio.png)
...
![Migrating from an email server to a web server](./images/CAP_Theorem-WebServer.drawio.png)
...
![Improving with many web servers and databases](./images/CAP_Theorem-WebServerResilient.drawio.png)
...
![Adding local storage](./images/CAP_Theorem-LocalStorage.png)
...
![Introduction of a cache](./images/CAP_Theorem-Cache.drawio.png)
...
![CAP dilemma](./images/CAP_Theorem-CAP_Triangle.drawio.png)
