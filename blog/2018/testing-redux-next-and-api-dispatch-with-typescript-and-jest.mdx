...
The code is tightly coupled with how you are handling your action. I strongly suggest using the [Redux-TypeScript boilerplate "free"](https://patrickdesjardins.com/blog/reducing-boilerplate-of-redux-with-typescript). It is really a relief to use in a term that you will create action within 30 seconds and to be type safe for the payload.
