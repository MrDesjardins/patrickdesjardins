...
```typescript
describe("Test Class A", () => { describe("method 1", () => { describe("when parameter a < 0", () => { it("throwns an exception", () => { }); }); describe("when parameter a == 0", () => { it("returns 0", () => { }); }); describe("when parameter a > 0", () => { it("returns xyz", () => { }); }); }); }); 
``` 
...
```typescript
describe("Test Class A", () => { let myObj: ObjectType1; describe("method 1", () => { beforeEach(() => { moObj = new ObjectType1(); }); describe("when parameter a < 0", () => { it("throwns an exception", () => { }); }); describe("when parameter a == 0", () => { it("returns 0", () => { }); }); describe("when parameter a > 0", () => { it("returns xyz", () => { }); }); }); }); 
``` 
