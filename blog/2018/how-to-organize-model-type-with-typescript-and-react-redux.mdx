...
[![](https://patrickdesjardins.com/blog/wp-content/uploads/2018/04/TypeScriptReduxModelsOrganization-1.png)](https://patrickdesjardins.com/blog/?attachment_id=5766)
...
The final result is of all the interface created look like this UML diagram: [![](https://patrickdesjardins.com/blog/wp-content/uploads/2018/04/TypeScriptReduxModelsOrganization.png)](https://patrickdesjardins.com/blog/?attachment_id=5765)
...
Here is an example of how React-Redux's connect function takes the model and dispatch types as well as how the React component for EntityA uses the property. ```typescript
export default connect<EntityAModel, EntityADispatch, {}, {}, ReduxState>( (s) => entityAMapper.mapStateToProps(s), (s) => entityAMapper.mapDispatchToProps(s), (stateProps, dispatchProps, ownProps) => Object.assign({}, ownProps, stateProps, dispatchProps), { pure: true, areStatesEqual: (n, p) => entityAMapper.shouldMappingBeSkipped(n, p) } )(EntityA)
