...
![](images/TypeScriptReduxModelsOrganization-1.png)
...
The final result is of all the interface created look like this UML diagram: ![](images/TypeScriptReduxModelsOrganization.png)
