...
\[csharp\] public class YourClass { public int Id{ get; set; } public dynamic Attributes { get; set; }

public MatriceRow() { Attributes = new ExpandoObject(); } } \[/csharp\]

This is a working example. From there you can use the YourClass class and set attributes. \[csharp\] var myClass = new YourClass(); myClass.Id = 1; myClass.Attributes.IsBoolean = true; myClass.Attributes.MyName = "Patrick Desjardins"; \[/csharp\]
