...
\[csharp\] public ActionResult Index() { return View("Index", "MasterPageCustom"); } \[/csharp\]

You could also use the View object and setting the master page name with a setter.

\[csharp\] public ActionResult SomeOtherPage() { var view = View("Index"); view.MasterName = "MasterPageCustom"; return view; } \[/csharp\]
