...
\[csharp\] \[HttpPost\] public ActionResult Edit(MyObject objModel) { objModel.Property1 = "NEW VALUE"; //... return View(objModel) } \[/csharp\]
...
\[csharp\] \[HttpPost\] public ActionResult Edit(MyObject objModel) { objModel.Property1 = "NEW VALUE"; //... ModelState.Clear(); return View(objModel) } \[/csharp\]
...
\[csharp\] ModelState.Remove("Property1"); \[/csharp\]
...
\[csharp\] My Property: <input type="text" name="Property1" value="@Model.Property1" /> \[/csharp\]
