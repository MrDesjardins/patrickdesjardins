...
![](images/recaptchaMVCScreen-331x400.png)
...
The second step is to have library to access ReCaptcha. Inside your project, add the two following NuGet Package. One is the Recaptcha API service and the other one will give you **Html helper**. ![](images/recaptchaMVC1-400x131.png)
