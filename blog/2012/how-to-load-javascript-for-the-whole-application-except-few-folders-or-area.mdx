...
When you want to load a specific resource like a Javascript file or a CSS file depending of a view, you can use a [RenderSection](http://patrickdesjardins.com/blog/how-to-add-javascript-and-css-dynamically-to-your-view-with-asp-net-mvc4).
...
\[csharp\] @{ Layout = "~/Views/Shared/\_MasterPage.cshtml"; } \[/csharp\]
...
\[csharp\] //\_ViewStart.cshtml : At the root for every views @{ Layout = "~/Views/Shared/\_Layout.cshtml"; <script src="@Url.Content("~/Scripts/myFile.js")" type="text/javascript" > </script> } \[/csharp\] \[csharp\] //\_ViewStart.cshtml : Inside the View directory of the Area @{ Layout = "~/Views/Shared/\_Layout.cshtml"; } \[/csharp\] This won't work because the \_ViewStart.cshtml will be executed first and add the script.

To solve this issue you can use TempData.

\[csharp\] //\_ViewStart.cshtml : At the root for every views @{ Layout = "~/Views/Shared/\_Layout.cshtml"; ViewContext.TempData.Add("MyFileKey", @Url.Content("~/Scripts/MyFile.js")); } \[/csharp\] \[csharp\] //\_ViewStart.cshtml : Inside the View directory of the Area @{ Layout = "~/Views/Shared/\_Layout.cshtml"; ViewContext.TempData.Remove("MyFileKey"); } \[/csharp\]

This require you to modify the Layout also : \[csharp\] <head> ... @if(ViewContext.TempData.ContainsKey("MyFileKey")) { <script src="@ViewContext.TempData\["MyFileKey"\]" type="text/javascript" > </script> } ... </head> \[/csharp\]
