...
\[csharp\] public static MvcHtmlString MyExtensionXZY<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string anyThing) { //... } public static MvcHtmlString MyExtensionXZY<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string anyThing, object htmlAttributes) { //... } \[/csharp\]

Or this can be with a default value: \[csharp\] public static MvcHtmlString MyExtensionXZY<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, string anyThing, object htmlAttributes=null) { //... } \[/csharp\]
...
\[csharp\] @Html.MyExtensionXZY("Test", new {class= "MyClass"}); \[/csharp\]
...
\[csharp\] myControl.MergeAttributes(System.Web.Mvc.HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes), true); \[/csharp\]

So, what it does is that it takes the object html Attribute and convert it into a dictionnary. The method AnonymousObjectToHtmlAttributes is available in System.Web.Mvc.HtmlHelper: \[csharp\] public static RouteValueDictionary AnonymousObjectToHtmlAttributes(object htmlAttributes) { RouteValueDictionary result = new RouteValueDictionary();
