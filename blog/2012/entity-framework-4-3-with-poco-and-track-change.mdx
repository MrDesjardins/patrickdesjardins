...
\[csharp\] dbContext.Configuration.LazyLoadingEnabled = false; dbContext.Configuration.ProxyCreationEnabled = false; dbContext.Configuration.AutoDetectChangesEnabled = true; dbContext.Configuration.ValidateOnSaveEnabled = false; \[/csharp\]
...
\[csharp highlight="4,12"\] var dbContext = new MyDbContext(connectionString); dbContext.Configuration.LazyLoadingEnabled = false; dbContext.Configuration.ProxyCreationEnabled = false; dbContext.Configuration.AutoDetectChangesEnabled = false; dbContext.Configuration.ValidateOnSaveEnabled = false;

var myObjects = dbContext.MyObject.Include("MySubObject"); foreach (var c in myObjects) { c.UpdateDate = DateTime.Now.ToString(); } dbContext.ChangeTracker.DetectChanges(); dbContext.SaveChanges(); \[/csharp\]
...
\[csharp\] var e = dbContext.ChangeTracker.Entries(); foreach (var dbEntityEntry in e) { Console.WriteLine(dbEntityEntry.State); } \[/csharp\]
