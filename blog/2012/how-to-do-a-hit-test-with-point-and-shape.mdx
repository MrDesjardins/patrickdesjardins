...
```csharp
 void myCanvas\_MouseRightButtonDown(object sender, MouseButtonEventArgs e) { e.Handled = true; Point currentMousePosition = e.GetPosition(this.myCanvas); var underMouseControls = GetControlFromCoordonate(currentMousePosition); } 
```
