...
\[csharp\] public class Person { public string Name { get; set; } } \[/csharp\]
...
\[csharp\] public class Person { \[Display(ResourceType = typeof(ResourceFileTypeHere), Name="NamePropertyKey")\] public string Name { get; set; } } \[/csharp\]
