...
\[csharp\] public ActionResult Edit(int id) { //... } \[/csharp\]

and in the same controller having:

\[csharp\] public ActionResult Edit(MyObjectToEdit obj) { //... } \[/csharp\]
...
\[csharp\] \[HttpGet\] public ActionResult Edit(int id) { //... }

\[HttpPost\] public ActionResult Edit(MyObjectToEdit obj) { //... } \[/csharp\]
...
- The browser support "\_\_defineSetter\_\_" which is where the vulnerability is executed. this one, you have no control.
...
\[csharp\] return Json(new { MyData = 1, MyData2= "ASD" }, JsonRequestBehavior.AllowGet); \[/csharp\]
