...
```csharp
 System.Reflection.MethodBase.GetCurrentMethod().Name.Replace("set\_", string.Empty) 
```
...
```csharp
 public string CustomerEmail { get { return \_customerEmail; } set{ \_customerEmail = value; Modified(System.Reflection.MethodBase.GetCurrentMethod().Name.Replace("set\_", string.Empty)); } } 
```
...
```csharp
 private string GetPropertyName() { var callStackTrace = new StackTrace(); var propertyFrame = callStackTrace.GetFrame(1); var properyAccessorName = propertyFrame.GetMethod().Name; return properyAccessorName.Replace("get\_","").Replace("set\_",""); } 
```
