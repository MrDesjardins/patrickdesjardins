...
\[csharp\] public virtual void DetectChanges(bool force = false) { if (this.AutoDetectChangesEnabled || force) { this.ObjectContext.DetectChanges (); } } \[/csharp\]

To disable the auto detect changes you need to set the context to false. the AutoDetectChanges is inside the Configuration property. \[csharp\] context.Configuration.AutoDetectChangesEnabled = false; \[/csharp\]
...
\[csharp\] YourDbContext.ChangeTracker.DetectChanges(); //Manually detect changes \[/csharp\]
