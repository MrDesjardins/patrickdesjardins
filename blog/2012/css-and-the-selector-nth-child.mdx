...
\[css\] ul>li:nth-child(3) { color: red; } \[/css\]
...
\[css\] ul>li:nth-child(2n+1) { background-color: red; } \[/css\]
...
\[html\] <ul> <li>n=0</li> <li>n=1</li> <li>n=2</li> <li>n=3</li> <li>n=4</li> <li>n=5</li> </ul> \[/html\]
