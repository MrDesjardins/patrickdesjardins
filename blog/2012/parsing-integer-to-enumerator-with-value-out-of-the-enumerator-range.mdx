...
\[csharp\] public enum MyEnumType { KeyA = 1, KeyB = 2 }

class Program { static void Main(string\[\] args) { int myIntegerValue = 1; MyEnumType enu = (MyEnumType)myIntegerValue; Console.Read(); } } \[/csharp\]
