...
This will work if the value, in our example 1, is in the MyEnumType. It will also work if we use an integer over 2. ![](images/enumOutOfRange-400x212.png)
...
![](images/enumTryParse-400x185.png)
...
![](images/enumDefined-400x237.png)
