...
[![](http://patrickdesjardins.com/blog/wp-content/uploads/2012/09/pnp_logo.png "pnp_logo")](http://patrickdesjardins.com/blog/?attachment_id=1525)
...
\[csharp highlight="12"\] protected void Application\_Start() { AreaRegistration.RegisterAllAreas();
...
var connectionString = System.Configuration.ConfigurationManager.ConnectionStrings\["DefaultConnection"\].ConnectionString; UnityConfiguration.Initialize(connectionString); } \[/csharp\]
