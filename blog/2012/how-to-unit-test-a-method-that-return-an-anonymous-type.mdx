...
\[csharp\] public JsonResult Update(MyObject o) { //... return Json(new { IsSaved = false, Id = 123}); } \[/csharp\]
...
\[csharp\] dynamic returnedData = myController.Update(new MyObject()); \[/csharp\]
...
\[csharp\] \[assembly: InternalsVisibleTo("Tests.Unit")\] \[/csharp\]
