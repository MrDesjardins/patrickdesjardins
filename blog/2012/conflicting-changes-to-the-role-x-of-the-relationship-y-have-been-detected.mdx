...
[![](http://patrickdesjardins.com/blog/wp-content/uploads/2012/08/ID-10078092.jpg "Headache")](http://patrickdesjardins.com/blog/conflicting-changes-to-the-role-x-of-the-relationship-y-have-been-detected/id-10078092)

\[csharp\] public class MyEntity { public virtual MySecondEntity MySecond{get;set;} public int MySecondEntityID{get;set;} } \[/csharp\] The code above can trig the error :
...
But, let say that you have this error without having this kind of structure. Let say you only use reference to the object (like I do). \[csharp\] public class MyEntity { public virtual MySecondEntity MySecond{get;set;} } \[/csharp\]
