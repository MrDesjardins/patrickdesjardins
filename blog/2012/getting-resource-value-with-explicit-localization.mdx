...
\[csharp\] public class MyResource{ public static string Res1 { get { return ResourceManager.GetString("Res1", resourceCulture); } } } \[/csharp\]
...
\[csharp\] //Instead of : string myString = MyResource.Res1; //You have to call : string myString = MyResource.ResourceManager.GetString("Res1", new CultureInfo("FR")); \[/csharp\]
