...
\[csharp\] public class RepositoryFactory : IRepositoryFactory { private IClassA a; private IClassB b; private IClassC c;
...
public IClassC RepoC { get { return c ?? (c = new RepoC(this.dbContext)); } } } \[/csharp\]
