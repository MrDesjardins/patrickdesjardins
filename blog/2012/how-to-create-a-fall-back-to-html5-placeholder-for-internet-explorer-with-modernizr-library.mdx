...
\[html\] <script src="/Scripts/Libs/jquery-1.8.2.js" type="text/javascript"> </script> <script src="/Scripts/Libs/modernizr-1.7.min.js" type="text/javascript"> </script> \[/html\]
...
\[html\] <input type="text" placeholder="This is a placeholder text"/> \[/html\]
