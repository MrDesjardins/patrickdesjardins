...
\[csharp\] var encoding= new UnicodeEncoding(); Byte\[\] bytesToCompress = encoding.GetBytes("Test123); var streamToCompress = new MemoryStream(); streamToCompress .Write(bytesToCompress, 0, bytesToCompress.Length); \[/csharp\]
