...
HasRequired with association defined by string: \[csharp\] this.HasRequired(a => a.Property1) .WithMany() .Map(a => a.MapKey("MyFK")); \[/csharp\]

HasRequired with association defined by property: \[csharp\] this.HasRequired(a => a.Property1) .WithMany() .HasForeignKey(a => a.MyFK); \[/csharp\]
