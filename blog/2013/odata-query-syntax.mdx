...
\[csharp\] http://yourwebsite/YourService.svc/YourEntitiesSet?$orderby=OneOfYourProperty

http://yourwebsite/YourService.svc/YourEntitiesSet?$orderby=OneOfYourProperty,ASecondProperty \[/csharp\]
...
\[csharp\] http://yourwebsite/YourService.svc/YourEntitiesSet?$top=10 \[/csharp\]
...
\[csharp\] http://yourwebsite/YourService.svc/YourEntitiesSet?$skip=20&$top=10 \[/csharp\]
...
\[csharp\] http://yourwebsite/YourService.svc/YourEntitiesSet?$filter=YourProperty equal('Test') \[/csharp\]
...
\[csharp\] http://yourwebsite/YourService.svc/YourEntitiesSet?$expand=YourPropertyThatLinkToAnOtherEntity \[/csharp\]
...
\[csharp\] http://yourwebsite/YourService.svc/YourEntitiesSet?$select=Property1,Property2 \[/csharp\]
