...
To solve this issue we need to delete cascade instead of a simple remove. We have seen in a previous post how to use [delete in cascade with Entity Framework](http://patrickdesjardins.com/blog/entity-framework-4-3-delete-cascade-with-code-first-poco).
...
\[csharp\] ...HasMany(e => e.ParentDetails) .WithOptional(s => s.Parent) .WillCascadeOnDelete(true); \[/csharp\]
