...
\[csharp\] public partial class MyService: DataService<MyDbContext> { //... } \[/csharp\]

You will have to also specify which entities is allowed to be accessed in InitializeService.

\[csharp\] public static void InitializeService(DataServiceConfiguration config) { //... } \[/csharp\]
