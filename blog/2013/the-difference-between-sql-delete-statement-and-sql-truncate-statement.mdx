...
One action that we have to do quite often is to remove data from tables. This can be done with the keyword delete or truncate. Here is two examples. \[sql\] --Delete DELETE FROM Table123

\--Truncate TRUNCATE TABLE Table123 \[/sql\]
...
\[sql\] --This will work DELETE FROM Table123 WHERE startDate <= 2013-06-14

\--This won't work TRUNCATE TABLE Table123 WHERE startDate <= 2013-06-14 -- Error! \[/sql\]
