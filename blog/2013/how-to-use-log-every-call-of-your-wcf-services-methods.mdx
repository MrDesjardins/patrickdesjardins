...
```csharp
 public class LoggingOperationBehavior : IOperationBehavior { private readonly ILog \_myLog;
...
```csharp
 public class LoggingOperationInvoker : IOperationInvoker { private readonly IOperationInvoker \_baseInvoker; private readonly string \_operationName; private readonly string \_controllerName; private readonly ILog \_myLog;
