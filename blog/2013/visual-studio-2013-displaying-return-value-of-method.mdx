...
\[csharp highlight="13"\] class Program { static void Main(string\[\] args) { var x = Method1(); Console.WriteLine(x); Console.ReadLine(); }

private static string Method1() { return "Method1 call " + Method2(); }

private static string Method2() { return "From Method2" + Method3(); }

private static string Method3() { return "From Method3"; } } \[/csharp\]

If we set a breakpoint to the _Method1_ and we hit next, we will be at the ending curly bracket. Normally, we won't see the value of _"Method1 call " + Method2();_

Now, we can see it.

[![ReturnValue](http://patrickdesjardins.com/blog/wp-content/uploads/2013/09/ReturnValue-400x316.png)](http://patrickdesjardins.com/blog/?attachment_id=2316)
