...
The code above is in the BaseRepository class of the project described in the "[Enterprise project](./enterprise-asp-net-part-1-mvc-the-planification "Enterprise Asp.Net MVC Part 1: The Planification")". As you can see, it takes as its second parameter an **expression of a function**. This will let use this method by specifying in a Lambda expression witch property to update.
