...
\[xml\] <dependentAssembly> <assemblyIdentity name="assemblyWithDependencyProblem" publicKeyToken="32ab4ba45e0a69a1" culture="en-us" /> <bindingRedirect oldVersion="1.0.0.0" newVersion="2.0.0.0" /> </dependentAssembly> \[/xml\]

\[code\] Project A --> Library A --> Dependency 1 (version1) |---------> Dependency 2 (version2) \[/code\]
