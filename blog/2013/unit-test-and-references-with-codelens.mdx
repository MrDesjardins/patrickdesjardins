...
The first information CodeLens add over your method signature is the number of reference that the method does has. References are all codes entries that your code contain to the method where the information is added. If you are using ReSharper, you may find it similar to “Find Usage” feature but with the advantage of being dynamically available for all your method directly in Visual Studio. Visual Studio add this information directly above the method which allow to be very rapid to figure out if the method is used and where the method is called. To see it in action, open Visual Studio 2013 Ultimate Edition and select any of your existing project. The reference count will be written in small gray letter above each classes and each methods. [![reference](http://patrickdesjardins.com/blog/wp-content/uploads/2013/10/reference-400x191.png)](http://patrickdesjardins.com/blog/unit-test-and-references-with-codelens/reference)

To be able to get additional information concerning reference, pressing ALT+2 or clicking on the numbers of reference open a contextual window with all calls occurrences. You can from there select a reference to be transported directly to the file and line that call the method. [![reference2](http://patrickdesjardins.com/blog/wp-content/uploads/2013/10/reference2-400x173.png)](http://patrickdesjardins.com/blog/unit-test-and-references-with-codelens/reference2)

It also possible from the same menu to generate the Code Map of the method. This is an interesting way to see all references links. [![reference3](http://patrickdesjardins.com/blog/wp-content/uploads/2013/10/reference3-400x162.png)](http://patrickdesjardins.com/blog/unit-test-and-references-with-codelens/reference3)

If you do not want to move to the usage of your method because you just want to have a look but not to move from where you are, you can. To see the code that use it, you can have a small snapshot of 2 lines before and 2 lines after the call by moving the focus on a reference without clicking. [![reference4](http://patrickdesjardins.com/blog/wp-content/uploads/2013/10/reference4-400x101.png)](http://patrickdesjardins.com/blog/unit-test-and-references-with-codelens/reference4)
...
[![reference5](http://patrickdesjardins.com/blog/wp-content/uploads/2013/10/reference5-400x179.png)](http://patrickdesjardins.com/blog/unit-test-and-references-with-codelens/reference5)
