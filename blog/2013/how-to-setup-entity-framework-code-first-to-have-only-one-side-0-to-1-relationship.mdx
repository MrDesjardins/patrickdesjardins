...
\[csharp\] modelBuilder .Entity<EntityOne>() .HasOptional(d => d.EntityTwo) .WithOptionalDependent(); \[/csharp\]
...
\[csharp\] modelBuilder .Entity<EntityOne>() .HasOptional(d => d.EntityTwo) .WithOptionalDependent() .Map(d => d.MapKey("EntityTwoID"); \[/csharp\]
