...
```html  <ul> <li id="step1">This is Step 1 <ul> <li>This is inside Step 1</li> </ul> </li> <li id="step2">This is Step 2 </li> </ul> 
``` 

If we use "step1.html()". The output is:


```html  This is Step 1 <ul> <li>This is inside Step 1</li> </ul> 
``` 

If we use "step1.text()". The output is:


```html  This is Step 1 This is inside Step 1 
``` 
