...
```csharp
public class WebApiApplication : System.Web.HttpApplication { protected void Application\_Start() { AreaRegistration.RegisterAllAreas();
...
```csharp
 internal class ScopeContainer : IDependencyScope { protected readonly IUnityContainer \_container;
