...
```html  <div class="card-container"> <div class="card"> <div class="side"><img src="thisisanimage.png"/></div> <div class="side back">This is some text</div> </div> </div> 
``` 
