...
\[html\] <button type="submit" name="ActionSave" value="insert">Save</button> <button type="submit" name="ActionSave" value="insertAndContinue">Save and continue</button> \[/html\]
...
\[csharp\] if (Request.Form\[CommandButtonName\] == SaveAndContinue) { // ... } else... \[/csharp\]
...
\[csharp\] if (model.Action == SaveAndContinue) { // ... } \[/csharp\]
