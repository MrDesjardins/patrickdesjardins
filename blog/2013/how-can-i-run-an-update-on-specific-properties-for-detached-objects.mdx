...
\[csharp\] context.Entry(yourObject).Property(u => u.YourProperty).IsModified = true; \[/csharp\]
...
\[csharp\] using (var entities = new MyDbContext()) { var entity = new YourEntity {Id = id, Name="Test"}; entities.YourEntities.Attach(entity); entities.Entry(entity).Property(e => e.Name).IsModified = true; entities.SaveChanges(); } \[/csharp\]
...
\[sql\] UPDATE YourEntity SET Name = "Test" WHERE Id = 123; \[/sql\]
...
\[csharp\] entities.Configuration.ValidateOnSaveEnabled = false; \[/csharp\]
