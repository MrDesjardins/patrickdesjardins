...
\[csharp\] modelBuilder .ComplexType<Audit>() .Property(type => type.CreatedBy) .HasColumnName("CreatedBy"); \[/csharp\]

In the database instead of having a field with "Audit\_CreatedBy" you will have only "CreatedBy". This may be useful in some situation, but by experience it's easier to do the mapping between complex type when you **keep** the prefix. It's up to you, and your coding/database standard, to figure out if it's appropriate or not.
