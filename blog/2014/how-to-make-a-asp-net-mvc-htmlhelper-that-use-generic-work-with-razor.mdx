...
\[csharp\] @Html.Test<ContestListItemViewModel>() //Does not work \[/csharp\]

The Html Helper is very simple.

\[csharp\] public static MvcHtmlString Test<TEntityType>(this HtmlHelper htmlHelper) { return new MvcHtmlString("<p>Test</P>"); } \[/csharp\]

To make it works, you have to have it inside a Razor statement like this: \[csharp\] @{ var x = Html.Test<ContestListItemViewModel>(); @Html.Raw(x); } \[/csharp\]
...
\[csharp\] @(Html.Test<ContestListItemViewModel>()) \[/csharp\]
