...
``` 
 The output is about the same but now we have three JavaScript file loaded in parallel. ![](images/requireAsync-400x127.png)

Let's do a comparison of these JavaScript files loaded without Require.js to see how it would have looks. ![](images/requireNoRequireOuputPerformance-400x119.png)
