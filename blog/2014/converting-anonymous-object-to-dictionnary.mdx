...
```csharp
 [TestClass] public class ObjectExtensionsTest { [TestMethod] public void GivenAnObject\_WhenThisOneHasMultipleProperties\_ThenDictionary() { // Arrange var objectToConvert = new {Id="Test", Name="Test2"};
