...
``` 
[![FiddlerSingleStringPost](http://patrickdesjardins.com/blog/wp-content/uploads/2014/05/FiddlerSingleStringPost-400x286.png)](http://patrickdesjardins.com/blog/asp-net-web-api-getting-401unauthorized-code/fiddlersinglestringpost)
...
```csharp
 public void Post([FromBody]DTOExecutionParameters value) { } public class DTOExecutionParameters { public string NameTask { get; set; } public string ParameterName { get; set; } } 
```
