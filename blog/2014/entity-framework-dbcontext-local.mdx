...
``` [![LocalQueryDatabase](http://patrickdesjardins.com/blog/wp-content/uploads/2014/05/LocalQueryDatabase-400x102.png)](http://patrickdesjardins.com/blog/entity-framework-dbcontext-local/localquerydatabase)
...
```sql
 SELECT [Extent1].[Id] AS [Id], [Extent1].[Name] AS [Name], [Extent1].[BirthDate] AS [BirthDate], [Extent1].[Person\_Id] AS [Person\_Id], [Extent1].[Residence\_Id] AS [Residence\_Id], [Extent1].[House\_Id] AS [House\_Id] FROM [dbo].[People] AS [Extent1] 
```
