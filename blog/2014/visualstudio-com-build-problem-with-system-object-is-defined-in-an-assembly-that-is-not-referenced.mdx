...
\[xml\] <system.web> <compilation debug="true" targetFramework="4.5.2"> <assemblies> <add assembly="System.Runtime, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" /> </assemblies> </compilation> <httpRuntime targetFramework="4.5.2"/> </system.web> \[/xml\]
...
[![MsBuildTargetVersion](http://patrickdesjardins.com/blog/wp-content/uploads/2014/08/MsBuildTargetVersion-400x312.png)](http://patrickdesjardins.com/blog/visualstudio-com-build-problem-with-system-object-is-defined-in-an-assembly-that-is-not-referenced/msbuildtargetversion)
