...
To be able to test that you can use Fiddler. Fiddler let's you see all Http traffic but it can also let you play with responses. To do, open the **AutoResponse** tab. ![](images/FiddleAutoResponse-400x210.png)
