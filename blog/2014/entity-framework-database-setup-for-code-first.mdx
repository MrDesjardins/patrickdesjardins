...
\[csharp\] public class Person { public int Id { get; set; } public int Name { get; set; } public DateTime BirthDate { get; set; }
...
public class Address { public string Street { get; set; } public int Number { get; set; } public string City { get; set; } } \[/csharp\]
...
[![EntityFrameworkAddNugetReference](http://patrickdesjardins.com/blog/wp-content/uploads/2014/05/EntityFrameworkAddNugetReference-400x129.png)](http://patrickdesjardins.com/blog/entity-framework-database-setup-for-code-first/entityframeworkaddnugetreference)
...
\[csharp\] public static void BuildDatabase() { using (var context = new YourContext()) { context.Database.Initialize(true); } } \[/csharp\]

We could also add an Entity to the database to generate the database automatically. This would produce the same result.

\[csharp\] public static void BuildByAddingEntity() { using (var context = new YourContext()) { var stud = new Person() { Name = "Person1", BirthDate = new DateTime(1990, 01, 01) }; context.Persons.Add(stud); context.SaveChanges(); } } \[/csharp\]
...
[![SqlManagerEntityFrameworkDatabaseName](http://patrickdesjardins.com/blog/wp-content/uploads/2014/05/SqlManagerEntityFrameworkDatabaseName.png)](http://patrickdesjardins.com/blog/entity-framework-database-setup-for-code-first/sqlmanagerentityframeworkdatabasename)
...
\[xml\] <configSections> <!-- For more information on Entity Framework configuration, visit http://go.microsoft.com/fwlink/?LinkID=237468 --> <section name="entityFramework" type="System.Data.Entity.Internal.ConfigFile.EntityFrameworkSection, EntityFramework, Version=6.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" requirePermission="false" /> </configSections> <connectionStrings> <add name="DefaultConnection" connectionString="Data Source=(LocalDb)\\v11.0;Initial Catalog=EntityFrameworkTestConsole;Integrated Security=True" providerName="System.Data.SqlClient" /> </connectionStrings> \[/xml\]

\[csharp highlight="3"\] public class YourContext : DbContext { public YourContext(): base("DefaultConnection") {

} public DbSet<Person> Persons { get; set; } public DbSet<House> Houses { get; set; } } \[/csharp\]
...
[![SqlManagerEntityFrameworkDatabaseName2](http://patrickdesjardins.com/blog/wp-content/uploads/2014/05/SqlManagerEntityFrameworkDatabaseName2.png)](http://patrickdesjardins.com/blog/entity-framework-database-setup-for-code-first/sqlmanagerentityframeworkdatabasename2)

Entity Framework takes care of everything for you. Tables are created from your entity defined in your context. It also takes care of all primary keys and foreign keys for you. [![DatabaseTables](http://patrickdesjardins.com/blog/wp-content/uploads/2014/05/DatabaseTables.png)](http://patrickdesjardins.com/blog/entity-framework-database-setup-for-code-first/databasetables)
