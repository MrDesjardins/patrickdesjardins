...
The first thing is to create a repository. You can create one free at GitHub. After created the repository on GitHub get the URL of the repository and copy paste to the console with the **clone** command. ![](images/GitHubCloneHttpUrl-400x247.png)

Download the repository to your computer with the **clone** command. 
``` 
 git clone https://github.com/MrDesjardins/TestingGit.git 
```  
![](images/GitCloneExistingRepository-400x66.png)
``` 
 git add README.md 
...
From there we can do several thing like a pull request, pulling directly or pushing to another branch. Let's first stats with a pull request. To do, you need to go on Github. ![](images/GitComment-336x400.png)
...
Like in this example, conflict can occur. ![](images/GitStatusConflict-400x149.png)
