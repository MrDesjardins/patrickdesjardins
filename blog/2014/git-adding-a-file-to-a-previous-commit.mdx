...
For example, here is a small commit of 1 file. \[code\] git add main.cs git commit -m "This is my first commit" \[/code\]

This is how to add a second file to this first commit. \[code\] git add util.cs git commit --amend --no-edit \[/code\]
