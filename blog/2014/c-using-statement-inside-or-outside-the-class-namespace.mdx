...
\[csharp\] var x = new OtherLibrary.OtherNameSpace.Xyz.TheClass(); \[/csharp\]
...
\[csharp highlight="1"\] using System; namespace MyNameSpace {

public class MyClass { //... } } \[/csharp\] But this could also be different by having the System namespace directly inside the namespace. \[csharp highlight="3"\] namespace MyNameSpace { using System; public class MyClass { //... } } \[/csharp\]
