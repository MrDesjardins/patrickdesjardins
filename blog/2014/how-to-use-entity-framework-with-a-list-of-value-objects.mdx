...
[![ContestMarket](http://patrickdesjardins.com/blog/wp-content/uploads/2014/03/ContestMarket-400x90.png)](http://patrickdesjardins.com/blog/how-to-use-entity-framework-with-a-list-of-value-objects/contestmarket)
...
\[csharp\] public class ContestMarketConfiguration : AssociationConfiguration { public ContestMarketConfiguration(): base(Constants.SchemaNames.Contest) { this.HasKey(c => new {MarketId = c.MarketId, ContestId= c.ContestId}); } } \[/csharp\]
...
\[csharp\] public class ContestMarketConfiguration : AssociationConfiguration { public ContestMarketConfiguration(): base(Constants.SchemaNames.Contest) { this.HasKey(c => new {MarketId = c.Market.Id, ContestId= c.Contest.Id}); } } \[/csharp\]
...
\[csharp\] public class ContestMarket { public Contest Contest { get; set; } public int ContestId { get; set; } public MarketType Market { get; set; } public int MarketId { get; set; } } \[/csharp\]
