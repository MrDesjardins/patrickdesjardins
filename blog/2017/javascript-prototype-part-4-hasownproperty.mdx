...
```typescript
var BaseClass1 = function() { this.m1 = "m1 base"; }; BaseClass1.prototype.m1 = "m1 proto base"; var ChildClass1 = function() { BaseClass1.call(this); // Call the constructor of the base class this.m1 = "m1 child"; }; ChildClass1.prototype = Object.create(BaseClass1.prototype); ChildClass1.prototype.m1 = "m1 child proto" ChildClass1.prototype.constructor = BaseClass1; var instance1 = new ChildClass1();
...
```typescript
var BaseClass1 = function() { //this.m1 = "m1 base"; }; BaseClass1.prototype.m1 = "m1 proto base"; var ChildClass1 = function() { BaseClass1.call(this); // Call the constructor of the base class //this.m1 = "m1 child"; }; ChildClass1.prototype = Object.create(BaseClass1.prototype); ChildClass1.prototype.m1 = "m1 child proto"; ChildClass1.prototype.constructor = BaseClass1; var instance1 = new ChildClass1(); console.log("Result " + instance1.hasOwnProperty("m1")); 
``` 
...
console.log("Result 1" + BaseClass1.hasOwnProperty("m1")); console.log("Result 2" + Object.prototype.hasOwnProperty.call(instance1,"m1")); 
``` 
...
```typescript
var BaseClass1 = function() { this.m2 = "m1 base"; }; BaseClass1.prototype.m3 = "m1 proto base"; var ChildClass1 = function() { BaseClass1.call(this); // Call the constructor of the base class this.m4 = "m1 child"; }; ChildClass1.prototype = Object.create(BaseClass1.prototype); ChildClass1.prototype.m1 = "m1 child proto"; ChildClass1.prototype.constructor = BaseClass1; var instance1 = new ChildClass1();

for (name in instance1) { console.log(name + ': ' + instance1\[name\]); } 
``` 
 The result is: \[code\] "m2: m1 base" "m4: m1 child" "m1: m1 child proto" "constructor: function () { this.m2 = 'm1 base'; }" "m3: m1 proto base" \[/code\]
...
for (name in instance1) { if(instance1.hasOwnProperty(name)){ console.log(name + ': ' + instance1\[name\]); } } 
``` 


Which returns: \[code\] "m2: m1 base" "m4: m1 child" \[/code\]
