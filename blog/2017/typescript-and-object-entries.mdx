...
\[javascript highlight="4"\] "lib": \[ "es6", "dom", "es2017.object" \] 
``` 
...
```typescript
export interface MyMap<T> { \[id: string\]: T; } 
``` 


From there you can do: ```typescript
const c: MyMap<MyObject> = {}; c\["myId1"\] = myObject1; c\["myId2"\] = myObject2; c\["myId3"\] = myObject3; const numberOfElementInDictionary = Object.entries(c).length; 
``` 
