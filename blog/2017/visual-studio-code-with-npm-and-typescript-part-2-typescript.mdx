...
```  Once it's done, download from npm typings, and execute the command to get the TypeScript definition file for JQuery. ```typescript
...
The file structures should look like: [![](http://patrickdesjardins.com/blog/wp-content/uploads/2017/02/TypingsIndexDTS.png)](http://patrickdesjardins.com/blog/visual-studio-code-with-npm-and-typescript-part-2-typescript/typingsindexdts) The index.d.ts contains a link to the JQuery's index.d.ts: ``` 
 /// <reference path="globals/jquery/index.d.ts" /> 
```  Finally, let's change the fileToInclude.ts to use JQuery: ```typescript
