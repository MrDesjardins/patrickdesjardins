...
The first piece of puzzle is to use the right server api key. It's under the Firebase console, under the setting's cog and under the **Cloud Messaging**. ![](images/ServerKeyFirebase-1024x415.png)
