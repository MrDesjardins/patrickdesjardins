...
The first step is to get the gulp sass package. You need to install the dependency has development since you won't need it at the browser level. \[code\] npm install gulp-sass --save-dev \[/code\]
...
SCSS: \[css\] body{ font-size:36px; span{ font-size:6px; } } \[/css\]

CSS: \[css\] body { font-size: 36px; } body span { font-size: 6px; } \[/css\]

HTML Output: [![](http://patrickdesjardins.com/blog/wp-content/uploads/2017/03/OutputScssCss.png)](http://patrickdesjardins.com/blog/?attachment_id=5077)
