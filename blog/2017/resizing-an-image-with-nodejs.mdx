...
From there, we need to import the module. We will bring the _path_ and _fs_ module of NodeJs to be able to create proper path syntax and to save file on disk. 
