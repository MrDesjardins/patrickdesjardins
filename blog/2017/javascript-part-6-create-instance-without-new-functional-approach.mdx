...
Here is the output: \[code\] "Can access private variable like : Private or the param i1" "\[BASE\] Can access private variable like : PrivateBase or the param Base!i1" "Can access private variable like : Private or the param i2" "\[BASE\] Can access private variable like : PrivateBase or the param Base!i2" \[/code\]
