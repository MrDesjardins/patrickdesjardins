...
Another book I read is ["The hundred-page machine learning book"](http://themlbook.com/) by Andriy Burkov. I read this paperback book as a compliment for my first course. The book is short and does not cover every topic as I was expecting (for example KNN is 1 page long) but the first chapters were interesting for me. Mostly about the notation summary because some of the topics were far in my memory.
