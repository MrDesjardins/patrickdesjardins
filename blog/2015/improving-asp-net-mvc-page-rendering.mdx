...
First of all, building in release instead of debug will help, but this will not be a game changer. This is something that stun me for several reasons. Mostly because if you search on Internet, this is the big optimization to do, but also because the compilation in release does not optimize the rendering properly. Here are three screenshot taken of [Glimpse](http://getglimpse.com). All benchmark results are from the same page that we will optimize during this article. The first one is the webpage in debug, without caching of any database calls. [![EntityFrameworkConnectionTime](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/EntityFrameworkConnectionTime-1024x161.png)](http://patrickdesjardins.com/blog/?attachment_id=4308)

The second one benchmark has the web application not reaching the database at all -- it use Redis to cache all the data queries. [![RedisPerformance](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/RedisPerformance-1024x155.png)](http://patrickdesjardins.com/blog/?attachment_id=4309)
...
[![ReleaseCompilationAndCache](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/ReleaseCompilationAndCache-1024x158.png)](http://patrickdesjardins.com/blog/?attachment_id=4313)
...
Build in Debug with reduction of Display Template: [![RemoveDisplayForTemplate](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/RemoveDisplayForTemplate-1024x159.png)](http://patrickdesjardins.com/blog/?attachment_id=4317)

Build in Releasewith reduction of Display Template: [![ReleaseWithoutDisplayFor](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/ReleaseWithoutDisplayFor-1024x161.png)](http://patrickdesjardins.com/blog/?attachment_id=4318)
