...
It's interesting to see that Microsoft is trying to better in term of localization but still fail to provide a perfect solution. Asp.Net Identity is by default English oriented but at least not hardcoded. It uses inside the Identity library a resource file. ![](images/BadExample-400x135.png)

Here is what you can see if your decompile Asp.Net Identity assembly. You will see a resource file with defined strings.

![](images/IdentityResourceFile.png)
...
![](images/AspNetIdentityCore-400x304.png)
