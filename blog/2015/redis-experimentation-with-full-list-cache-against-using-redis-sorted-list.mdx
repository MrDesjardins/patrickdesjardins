...
```csharp
 // Initial push db.SortedSetAdd("MyListOfObjectFoo\_PartitionRed\_Page\_1", new[] { new SortedSetEntry("User 1",100), new SortedSetEntry("User 2",99), new SortedSetEntry("User 3",99)});
