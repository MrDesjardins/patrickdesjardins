...
\[sql\] update YourTableName set YourColumnName = cast(rand(CHECKSUM(NEWID())) \* 500 as int) where Id = '9308cbb9-f079-4456-9bb8-d1de88367aaa' \[/sql\]
...
[![randomSqlValueUpdate](http://patrickdesjardins.com/blog/wp-content/uploads/2015/02/randomSqlValueUpdate.png)](http://patrickdesjardins.com/blog/sql-update-column-with-random-value/randomsqlvalueupdate)
