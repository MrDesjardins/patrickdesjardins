...
```html  <div id="box1" class="box"><i class="fa fa-spinner fa-spin"></i></div> <div id="box2" class="box"><i class="fa fa-spinner fa-spin"></i></div> 
```  [css] .box{ width:150px; height:150px; background-color:lightblue; margin:10px; }
