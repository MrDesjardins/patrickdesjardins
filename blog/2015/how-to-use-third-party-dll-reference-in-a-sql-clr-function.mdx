...
\[csharp\] \[Microsoft.SqlServer.Server.SqlFunction\] public static SqlString HashPassword2(string plainPassword) { var hasher = new Microsoft.AspNet.Identity.PasswordHasher(); return hasher.HashPassword(plainPassword); } \[/csharp\]
