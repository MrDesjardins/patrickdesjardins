...
\[csharp\] class Program { static void Main(string\[\] args) { var rendering = new ChildClass(); rendering.Render(); Console.ReadLine(); } }
...
[![Abstract](http://patrickdesjardins.com/blog/wp-content/uploads/2015/03/Abstract.png)](http://patrickdesjardins.com/blog/typescript-abstract-classes/abstract)
...
public render() { console.log('Base Start'); this.renderAbstract(); console.log('Base Start'); }

renderAbstract() { throw new Error('This method is abstract and must be overrided.'); }

} export class ChildClass extends BaseClass {

public renderAbstract(): void { console.log('- Child -'); } } 
``` 
