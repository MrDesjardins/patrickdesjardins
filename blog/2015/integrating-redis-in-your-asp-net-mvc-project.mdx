...
[![RedisServer](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/RedisServer-400x203.png)](http://patrickdesjardins.com/blog/?attachment_id=4272)

Once it's running, you can do a quick test with the Redis-cli console. You can set and get a value with a simple **set** and **get** command. [![RedisCliExample](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/RedisCliExample-400x72.png)](http://patrickdesjardins.com/blog/?attachment_id=4273) It's also possible to get all keys by using the **keys \*** command. Once everything work as expected, you can delete everything with the **flushall** delete command.
...
[![StackExchangeRedis](http://patrickdesjardins.com/blog/wp-content/uploads/2015/07/StackExchangeRedis-400x65.png)](http://patrickdesjardins.com/blog/?attachment_id=4274)
...
\[csharp\] public class RedisCache : ICache { private readonly ConnectionMultiplexer redisConnections;
