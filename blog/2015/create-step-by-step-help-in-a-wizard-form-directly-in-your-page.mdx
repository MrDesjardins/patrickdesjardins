...
[![LinkedInHopScotchExample](http://patrickdesjardins.com/blog/wp-content/uploads/2015/04/LinkedInHopScotchExample-400x149.png)](http://patrickdesjardins.com/blog/create-step-by-step-help-in-a-wizard-form-directly-in-your-page/linkedinhopscotchexample)
...
This modification is the following: 1) Search for getCurrTarget 2) Add the following code under the code found in step 1: ```typescript
...
//See \_Header.cshtml for the ID $('#page-help-button').click(function () { hopscotch.startTour(tour); });
...
Here is an animation of the final result. [video width="804" height="632" mp4="http://patrickdesjardins.com/blog/wp-content/uploads/2015/06/hopscotchBourseVirtuelle.mp4"][/video]
