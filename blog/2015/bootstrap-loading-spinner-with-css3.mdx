...
```  The JavaScript remains the same but a new addition is required in the CSS. [css] .glyphicon.spinning { animation: spin 1s infinite linear; -webkit-animation: spin2 1s infinite linear; }
