...
\[csharp\] var assembly = Assembly.GetCallingAssembly(); var resourceName = assembly.GetName().Name + ".YourTestContentFolder.SubClassFolder.SubMethodFolder.Input.html"; \[/csharp\]
...
\[csharp\] using (var stream = new StreamReader(assembly.GetManifestResourceStream(resourceName), Encoding.UTF8)) { //... } \[/csharp\]
