...
```html  <script id="my-island"> { prop1:'value1' , prop2:'value2' } </div> 
``` 
...
```html  <script> windows.application.variables = { prop1:'value1' , prop2:'value2' }; </script> 
...
```html  <div id="abc" data-prop1="value1"></div> 
``` 
