...
[![RedisServerWindowsSpaceHarddrive](http://patrickdesjardins.com/blog/wp-content/uploads/2015/09/RedisServerWindowsSpaceHarddrive.png)](http://patrickdesjardins.com/blog/?attachment_id=4353)

I am running Redis as a service on my machine since about 2 months and never realized that this one store the size of the ram of your machine in multiple files. Each files are named with "RedisQFork\_9076.dat" and the number vary. Each of them were 8 gigs because I had a 8 gig ram machine.
