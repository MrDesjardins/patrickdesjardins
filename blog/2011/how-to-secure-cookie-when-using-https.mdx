...
\[csharp\] var cookie = new HttpCookie("MyCookieName", "MyValue"); cookie.Secure = true; Response.Cookies.Add(cookie); \[/csharp\]
...
\[xml\] <httpCookies requireSSL="true" /> \[/xml\]
...
\[csharp\] \[RequireHttps\] public class MyLoginController: Controller { ... \[/csharp\]
...
\[csharp\] @Html.ActionLink("My Login Link", "LogOn", "MyLoginController", "https", null, null, null, null) \[/csharp\]
