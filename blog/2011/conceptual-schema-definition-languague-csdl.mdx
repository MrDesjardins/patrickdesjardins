...
[caption id="attachment\_132" align="aligncenter" width="400" caption="The 3 part of CSDL file"]![](images/csdl3part-400x290.png)
...
[csharp line="1"] var db = new NorthWindContainer(); var collectionData = db.Territories; 
```
...
[caption id="attachment\_133" align="aligncenter" width="380" caption="Lazy Loading Property of the Conceptual Entity Modal"]![](images/lazyloadingenabled.png)
