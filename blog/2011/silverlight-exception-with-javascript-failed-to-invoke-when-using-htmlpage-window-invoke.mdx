...
Silverlight can interact with the Javascript that reside in the page that this one is hold. We have seen in the [Silverlight Communication](./silverlight-communication-with-javascript "Silverlight communication with Javascript") post that it's possible with the use of _System.Windows.Browser.HtmlPage.Window.Invoke_.
