...
\[caption id="attachment\_446" align="aligncenter" width="400" caption="Performance Counter"\][![](http://patrickdesjardins.com/blog/wp-content/uploads/2011/09/performancecounter-400x294.png "performancecounter")](http://patrickdesjardins.com/blog/implementing-performance-counter-in-your-application/performancecounter)\[/caption\]
...
\[caption id="attachment\_447" align="aligncenter" width="366" caption="Some already available .Net counters"\][![](http://patrickdesjardins.com/blog/wp-content/uploads/2011/09/addcounter.png "addcounter")](http://patrickdesjardins.com/blog/implementing-performance-counter-in-your-application/addcounter)\[/caption\]
...
To create your counter, you need 'PerformanceCounterCategory.Create'. \[csharp\] PerformanceCounterCategory.Create("CategoryName", "CategoryHelpText", PerformanceCounterCategoryType.SingleInstance, "CounterNameInsideTheCategory", "CounterHelpText."); \[/csharp\]
...
\[csharp\] var pc = new PerformanceCounter("CategoryName", "CounterNameInsideTheCategory", false); pc.IncrementBy(10); \[/csharp\]
