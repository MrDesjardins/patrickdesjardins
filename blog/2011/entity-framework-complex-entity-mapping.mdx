...
In the AdventureWorks database once the model is generated from the database you get tables, views and stored procedure. For this exercise, lets take the generated entity "Department" ![](images/DepartmentEntity.png)

![](images/AddComplexType-400x247.png)
...
![](images/complextypewithproperties.png)
