...
[caption id="attachment\_114" align="aligncenter" width="400" caption="Scalar types"]![](images/scalartype-400x300.png)
...
In the AdventureWorks database once the model is generated from the database you get tables, views and stored procedure. For this exercise, lets take the generated entity "Department" [caption id="attachment\_115" align="aligncenter" width="254" caption="Department Entity"]![](images/DepartmentEntity.png)

[caption id="attachment\_116" align="aligncenter" width="400" caption="Context Menu to add a Complex Type"]![](images/AddComplexType-400x247.png)
...
[caption id="attachment\_117" align="aligncenter" width="364" caption="Complex type with properties"]![](images/complextypewithproperties.png)
