...
[caption id="attachment\_334" align="aligncenter" width="400" caption="Invalid Operation with DataSet Update"]![](images/updateDataSetRowsFromDataTable-400x100.png)
...
This will generate the InsertCommand as you can see in this screenshot: [caption id="attachment\_335" align="aligncenter" width="400" caption="Automatically create SQL statement with DbCommandBuilder"]![](images/createInsertStatementWithCommandBuilder-400x73.png)
