...
[caption id="attachment\_161" align="aligncenter" width="400" caption="Context dialog for mapping stored procedure"]![](images/mappingstoredprocedure-400x340.png)
...
[caption id="attachment\_162" align="aligncenter" width="400" caption="Mapping update function with a custom stored procedure"]![](images/mappingUpdateStoredProcedure-400x132.png)
...
```sql
 exec sp\_executesql N'update [dbo].[Region] set [RegionDescription] = @0 where ([RegionID] = @1) ',N'@0 nchar(50),@1 int',@0=N'Est',@1=1 
```
...
[caption id="attachment\_166" align="aligncenter" width="400" caption="Add direct call to stored procedure or function"]![](images/modelbrowseraffunction-400x327.png)

Once added, the stored procedure is set under the Function Imports of the Entity Framework Model.

[caption id="attachment\_167" align="aligncenter" width="379" caption="Result of adding a stored procedure"]![](images/addedfunction.png)
