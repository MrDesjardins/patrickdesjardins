...
\[xml\] <Button Command="MyCommand"> Click Me </Button> \[/xml\]
...
\[xml\] <Button Command="{Binding MyCommand}"> Click Me </Button> \[/xml\]

Of course, you need bind to a ICommand property to the desired command.

\[csharp\] public ICommand MyCommand { get { return .... } } \[/csharp\]
