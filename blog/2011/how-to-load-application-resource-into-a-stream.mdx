...
\[caption id="attachment\_481" align="aligncenter" width="346" caption="File Property"\][![](http://patrickdesjardins.com/blog/wp-content/uploads/2011/09/buildaction.png "buildaction")](http://patrickdesjardins.com/blog/how-to-load-application-resource-into-a-stream/buildaction)\[/caption\]
...
\[csharp\] ... = new Uri("Project1;component/Folder1/Folder2/Test.xml", UriKind.Relative) \[/csharp\]
...
\[csharp\] //... StreamResourceInfo sr1 = Application.GetResourceStream(new Uri("Project1;component/Folder1/Folder2/Test.xml", UriKind.Relative)); var file = new StreamReader(sr1.Stream); return file.ReadToEnd(); \[/csharp\]
