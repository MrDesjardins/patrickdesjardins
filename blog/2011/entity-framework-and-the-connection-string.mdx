...
\[csharp\] public AdventureWorks\_DataEntities() : base("name=AdventureWorks\_DataEntities", "AdventureWorks\_DataEntities") public AdventureWorks\_DataEntities(string connectionString) : base(connectionString, "AdventureWorks\_DataEntities") public AdventureWorks\_DataEntities(EntityConnection connection) : base(connection, "AdventureWorks\_DataEntities") \[/csharp\]
...
\[csharp\] string connectionString = ConfigurationManager.ConnectionStrings\["qwe"\]; \[/csharp\]
