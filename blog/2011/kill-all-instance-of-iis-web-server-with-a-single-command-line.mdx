...
\[code\] taskkill /f /im WebDev.\* \[/code\]

\[caption id="attachment\_589" align="aligncenter" width="400" caption="Taskkill with a lot of WebServer.exe "\][![](http://patrickdesjardins.com/blog/wp-content/uploads/2011/11/taskkill-400x113.png "taskkill")](http://patrickdesjardins.com/blog/kill-all-instance-of-iis-web-server-with-a-single-command-line/taskkill)\[/caption\]
