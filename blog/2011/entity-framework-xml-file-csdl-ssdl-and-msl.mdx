...
[caption id="attachment\_127" align="aligncenter" width="379" caption="Property of the Conceptual Entity Model to output the 3 XML files"]![](images/output3filesedmx.png)

This will output the CSDL, SSDL and MSL files in the bin folder.

[caption id="attachment\_128" align="aligncenter" width="297" caption="Debug directory with the 3 XML files"]![](images/output3filesedmx2.png)
