...
I recorded a video of the ESP-32 driving the TFT display. It works well, and I already have a newer version that clears only specific parts of the screen, which significantly reduces flickering.
