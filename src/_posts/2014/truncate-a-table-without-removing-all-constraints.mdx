...
This will result to remove data of the table in the fastest way possible. If you want to have more details you can check that article that I previously wrote about [Truncate vs Delete](./the-difference-between-sql-delete-statement-and-sql-truncate-statement "The difference between SQL Delete statement and SQL Truncate statement").
